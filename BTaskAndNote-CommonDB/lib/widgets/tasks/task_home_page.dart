      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError ||
            ...
            final List<QueryDocumentSnapshot<dynamic>> filteredTasks = snapshot
                .data!.docs
                .where((element) => (element['type'] == 'tasks' &&
                    element['createdBy'] ==
                        userRepository.currentUser!.reference.id))
                .toList();

            return Padding(
              padding: const EdgeInsets.all(8.0),
              child: ListView(
                children: filteredTasks.map<Widget>((doc) {
                  return Card(
                    color:
